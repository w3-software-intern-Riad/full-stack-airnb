      ...
      <div className={styles.reviewSection}>
        <div className={styles.reviewSectionLeft}>
          <div className={styles.reviewTitle}>
            ...
            <h4 className={styles.bedroomDetail}>2 guests . 1 bedroom . 1 bed . 1 bath</h4>
          ...
          <div className={styles.hosted}>
            ...
            <div className={styles.hostedDetails}>
              <h3>Hosted by Fernando</h3>
              <h4 className={styles.hostedDetail}>Superhosted . 7 years hosting</h4>
            </div>
          </div>
          <hr className={styles.horizontalLine} />
          <div className={styles.hosted}>
          ...
          <div className={styles.sleepSpaceDiv}>
            ...
            <img className={styles.sleepSpaceImage} src={Bedroom} alt="bedroom" />
            <h3>Bedroom</h3>
            <h4 className={styles.secondaryTextColor}>1 double bed</h4>
          </div>
          <br />
          <hr />
          <br />
          <div className={styles.placeOffer}>
            ...
            <button className={styles.btnShowAmenities}>Show all 32 amenities</button>
          </div>
          <br />
          <hr />
          <br />
